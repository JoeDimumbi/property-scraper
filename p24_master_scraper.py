...
# Main execution
def main():
    logging.info("Starting Property24 scraping process.")
    city_ids = scrape_property24_city_ids()
    if city_ids:
        urls = generate_property24_urls(city_ids)
        scrape_property24_listings(urls)
        logging.info("Property24 scraping completed successfully.")
    else:
